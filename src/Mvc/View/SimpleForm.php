...
abstract class SimpleForm extends BaseForm
{
    ...
    public function getWindowOpener($obj)
    {
        return null;
    }
    public function refreshParent($id = false, $class = false)
    {
        if ($id === false) {
    ...
    public function onSuccessfulOperation($operation, $action)
    {
    ...
    public function onSuccessfulAdd($action = self::ACTION_DEFAULT)
    {
        return $this->onSuccessfulOperation(OmRequest::OPERATION_ADD, $action);
    }

    public function onSuccessfulUpdate($action = self::ACTION_DEFAULT)
    {
        return $this->onSuccessfulOperation(OmRequest::OPERATION_UPDATE, $action);
    }

    public function onSuccessfulRemove($action = self::ACTION_DEFAULT)
    {
