...
class HTML
{
    ...
    public static function tag($name, $attr = array(), $close = HTML::TAG_CLOSE_NONE)
    {
    ...
    public static function submitButton($submit)
    {
        $name = $submit["name"];
        $submit["name"] .= "button";
    ...
    public static function tableRow($colTag, $rowAttr, $colAttr, $data)
    {
        if (!is_array($data)) {
            $data = func_get_args();
    ...
    public static function link($href, $text, $attr = null, $enabled = true)
    {
