...
class PdfTk
{
    public static function fdfUtf16($text, $encoding = "utf-8")
    {
    ...
    public static function fdf($data, $encoding = "utf-8")
    {
        $search = array('\\', '(', ')');
        $replace = array('\\\\', '\(', '\)');
    ...
    public static function fillForm($input, $output, $data, $encoding = "utf-8", $flatten = false)
    {
